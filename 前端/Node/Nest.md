...
通用的处理可以作为一个切面（aspect）来实现。![alt text](../../附件/images/img_js_32.png)
...
![alt text](../../附件/images/img_js_37.png)
AOP 面向切片编程
切片:
![alt text](../../附件/images/img_js_32.png)
直接增加一个切片，不影响原来的逻辑。
...
- Guard: 守卫，可以对请求进行拦截，比如权限验证、登录验证等。
  创建通过
  ![alt text](../../附件/images/img_js_34.png)
...
- interceptor: 拦截器，可以对请求进行拦截，比如请求参数验证、响应数据处理等。
  ![alt text](../../附件/images/img_js_35.png)
  他和 Guard 的区别就是:
...
- pipe: 管道，可以对请求参数进行处理，比如验证、类型转换等。
  ![alt text](../../附件/images/img_js_39.png)
...
- ExceptionFilter 可以对抛出的异常做处理，返回对应的响应：
  ![alt text](../../附件/images/img_js_33.png)
...
几者的执行顺序:
![alt text](../../附件/images/img_js_38.png)
