...
function LazyMan() {
  ...
  return {
    eat(food) {
      queue.push(() => console.log(`吃了 ${food}`))
      return this
    },
...
lazyMan.eat('apple') // 立即打印 "吃了 apple"
lazyMan.sleep(1000) // 1秒后打印 "睡了 1000 毫秒"

lazyMan.eat('apple').sleep(1000).eat('banana').sleep(1000).eat('orange').sleep(2000).eat('grape') 
// 打印: "吃了 apple"
// 1s后打印:  "睡了 1000 毫秒"
// 打印: "吃了 banana"
// 1s后打印:  "睡了 1000 毫秒"
